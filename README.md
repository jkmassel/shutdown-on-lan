...
##### Secret
The secret is the string that's sent to the machine in order to shut it down. By default, this is set to a random UUID. Be sure to use a strong secret for this – anyone on the network with the port number and this secret can shut down your machine!

_For security reasons, the secret cannot be longer than 4096 characters._
